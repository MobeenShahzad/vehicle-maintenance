...
class AddVehicalCardItemImage extends StatefulWidget {
  final String title;
  ...
  @override
  State<AddVehicalCardItemImage> createState() =>
      _AddVehicalCardItemImageState();
}

class _AddVehicalCardItemImageState extends State<AddVehicalCardItemImage> {
  IconData? icon;
  File? file;
